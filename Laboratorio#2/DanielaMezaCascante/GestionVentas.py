...
def imprimirfacturas():
    ...
    for n in listadoFacturas:
        ...
        print("La fecha factura es",n.fechafactura)
         #La fecha factura es 21/07/23
        print("El impuesto es",n.impuestofactura)
          #El impuesto es de 1.13
        print("El Nombre Completo es",n.nombreCliente)
        #El nombre completo es Daniela Meza Cascante
        print("La categoria venta es",n.categoriaVenta)
         #La categoria venta es A