...
def crearFactura(             
                 montofactura,
                 categoriaVenta, nombre, montoprin                 
                 ):
...
def imprimirfacturas():
    ...
    for n in listadoFacturas:
        print("nombre: ",n.nombreCliente)
        print("tipo de categoria: ",n.categoriaVenta)
        print("---------------{0} {1}".format(n.idfactura, "factura en colones"))
        #casting de dato convirtiendo de numero (int) a cadena de texto (str)
        print("El monto de la factura es de ",n.montoprin)
        print("Con descuento quedaria en ", n.montofactura)
