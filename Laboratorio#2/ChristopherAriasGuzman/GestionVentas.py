...
def crearFactura(             
    ...
    try:
        ...
        ofactura.nombreCliente = input("Digite el nombre de la persona para crear la factura:")
        ofactura.categoriaVenta= input("Digite la categoria de descuento A = 5%, B = 10%, C = Otro porcentaje")
