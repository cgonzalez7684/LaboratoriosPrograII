...
def crearFactura(montofactura, categoria_venta, desc, customer_name):
    ...
    try:
        ...
        ofactura.categoria_venta = categoria_venta
        ofactura.customer_name = customer_name
        ofactura.calc_desc = desc
        ofactura.calculaImpuesto()

        if categoria_venta == 'A':
            ofactura.calc_desc = montofactura * 0.05
        elif categoria_venta == 'B':
            ofactura.calc_desc = montofactura * 0.1
        elif categoria_venta == 'C':
            ofactura.calc_desc = desc
...
def imprimirfacturas():
    ...
    for n in listadoFacturas:
        ...
        print("El descuento de la factura es ", n.calc_desc)
        print("Monto final: ", n.montofactura - n.calc_desc)
        print("Nombre del cx: ", n.customer_name)
        print("Categoria: ", n.categoria_venta)
